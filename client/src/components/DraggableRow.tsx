...
export function DraggableRow({ id, children }: { id: string; children: ReactNode }) {
  ...
  return (
    <div ref={setNodeRef} style={{ transform: CSS.Translate.toString(transform) }} className={`rounded-lg border border-slate-200 bg-white p-2 shadow-sm ${isDragging ? "opacity-60" : ""}`}>
